...
app.post(properties.api + '/changePassword', function(req, res) {
    ...
    db_MyContacts_db.User.findOne({ username: req.user.username, password: req.body.passwordOld }).exec(function(err, user) {
...
var getUser = function(username, password, callback) {
    ...
    db_MyContacts_db.User.findOne({ username: username, password: password }).lean().exec(function(err, user) {
        callback(user);
    });
};
...
var createUser = function() {
    ...
    // db_MyContacts_db = require('../db/MyContacts_db_schema.js');
    // db_MyContacts_db.User.count().exec(function(err, count) {
    //     if (count == 0) {
    //         var admin = new db_MyContacts_db.User({
    //             username: 'admin',
